        ...
        <section>
          <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 mb-24">
              <a href="/details.html" class="compo-box">
                <div class="new-label">
                  <i></i>
                  New
                </div>
            ...
            <div class="col-lg-6 mb-24">
              <h1 class="h2 mb-24 w-auto w-lg-70">Animated Toggle Switch</h1>
              <p>Smooth micro-interaction toggle with 3 states</p>
              <div class="mt-24 btn-container">
                <a href="#" class="btn-primary"
                  >Open in Figma&nbsp;<img src="/wp-content/uploads/2026/05/figma.svg"
                /></a>
                <a href="#" class="bt-s-auto"
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box-use mb-24">
              <h4>Where to Use This</h4>
              <div class="d-flex g-2 mt-16 flex-wrap">
                <span class="tags">SaaS Dashboards</span>
                <span class="tags">Mobile Applications</span>
                <span class="tags">Web Apps</span>
                <span class="tags">Landing Pages</span>
                <span class="tags">Admin Panels</span>
                <span class="tags">E-commerce UI</span>
              </div>
            </div>
            <h4>License</h4>
